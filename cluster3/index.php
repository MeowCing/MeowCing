...
<main class="container">
    ...
    <div class="alert alert-primary mt-4" role="alert">
        Selamat Datang, 
        <b><?php echo $_SESSION['user']; ?>!</b> Silahkan Order Produk Yang Tersedia.
    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-sm-3">
            <form class="row" method="GET" action="<?php echo $siteURL; ?>/index.php">
                <div class="col-sm-8">
            ...
            <div class="col-sm-3">
                <div class="card w-100 border-0 rounded-3 shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <a href="<?php echo $siteURL .'/user/whistlist.php?product_id='. $data['id']; ?>" class="btn bg-outline-success text-dark w-100">keranjang</a>
                            </div>
                            <div class="col-sm-6">
                                <a href="<?php echo $siteURL .'/user/detail.php?product_id='. $data['id']; ?>" class="btn btn-outline-primary w-100">Detail Produk</a>
                            </div>
                        </div>
                    </div>
                </div>
